...
public class RecyclerviewCategoryViewHolder extends ParentViewHolder {
    ...
    public RecyclerviewCategoryViewHolder(View itemView) {
        super(itemView);
        mMovieTextView = (TextView) itemView.findViewById(R.id.tv_movie_info_category);

        mArrowExpandImageView = (ImageView) itemView.findViewById(R.id.iv_arrow_expand);
    }

    public void bind(RecyclerviewCategory movieCategory) {
